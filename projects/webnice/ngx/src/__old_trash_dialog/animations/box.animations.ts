import { animate, AnimationTriggerMetadata } from '@angular/animations';
import { keyframes, state, style, transition, trigger } from '@angular/animations';
import * as kf from './keyframes';


export const boxAnimations: AnimationTriggerMetadata = trigger(
  'boxAnimations',
  [
    ...
    transition(
      '* => zoomInRotate',
      animate('800ms ease-in', keyframes(kf.zoomInRotate))
    ),
    ...
    transition(
      '* => slideInUp',
      animate('400ms ease-in', keyframes(kf.slideInUp))
    ),
    transition(
      '* => slideInDown',
      animate('400ms ease-in', keyframes(kf.slideInDown))
    ),
    transition(
      '* => slideInLeft',
      animate('400ms ease-in', keyframes(kf.slideInLeft))
    ),
    transition(
      '* => slideInRight',
      animate('400ms ease-in', keyframes(kf.slideInRight))
    ),
    ...
    transition(
      '* => noneOut',
      animate('100ms ease-out', keyframes(kf.fadeOut))
    ),
    transition(
      '* => fadeOut',
      animate('300ms ease-out', keyframes(kf.fadeOut))
    ),
    transition(
      '* => zoomOutWind',
      animate('400ms ease-out', keyframes(kf.zoomOutWind))
    ),
    transition(
      '* => bounceOut',
      animate('400ms ease-out', keyframes(kf.bounceOut))
    ),
    transition(
      '* => flipOutY',
      animate('400ms ease-out', keyframes(kf.flipOutY))
    ),
    transition(
      '* => zoomOut',
      animate('400ms ease-out', keyframes(kf.zoomOut))
    ),
    transition(
      '* => zoomOutRotate',
      animate('400ms ease-out', keyframes(kf.zoomOutRotate))
    ),
    transition(
      '* => slideOutUp',
      animate('300ms ease-out', keyframes(kf.slideOutUp))
    ),
    transition(
      '* => slideOutDown',
      animate('300ms ease-out', keyframes(kf.slideOutDown))
    ),
    transition(
      '* => slideOutLeft',
      animate('300ms ease-out', keyframes(kf.slideOutLeft))
    ),
    transition(
      '* => slideOutRight',
      animate('300ms ease-out', keyframes(kf.slideOutRight))
    ),
